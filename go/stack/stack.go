...
import (
	...
	"gongng18/go/fullstack"
	"gongng18/go/models"
	"gongng18/go/orm"
	"gongng18/go/probe"

	gongng18_go "gongng18/go"
...
func (impl *BeforeCommitImplementation) BeforeCommit(stage *models.StageStruct) {
	...
	stage.Checkout()
	stage.Marshall(file, "gongng18/go/models", "main")
}
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongng18_go.GoModelsDir, gongng18_go.GoDiagramsDir,
