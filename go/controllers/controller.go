...
type Controller struct {
	...
	Map_BackRepos map[string]*gongng18_orm.BackRepoStruct
...
func GetController() *Controller {
	doControllerInitOnce.Do(func() {
		_controllerSingloton = &Controller{
			Map_BackRepos: make(map[string]*gongng18_orm.BackRepoStruct),
		}
	})
	return _controllerSingloton
}

func (controller *Controller) AddBackRepo(backRepo *gongng18_orm.BackRepoStruct, stackPath string) {
